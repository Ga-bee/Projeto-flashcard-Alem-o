...
#Dict receives the word chosen in german
chosen = {}
...
#activated when "right" button is clicked
def is_known():
...
def generate_words():
    ...
    #change the language and word to german and the chosen word on the card
...
def original_language():
    #change to your language and tranlate the word
